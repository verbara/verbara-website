...
const es_419: Messages = {
  ...
  home: {
    ...
    pt_card_self_price: 'desde $18k/año',
  ...
  pricing: {
    ...
    tier_2_price: 'desde $18.000 / año · 25 agentes licenciados',
    ...
    faq_a2: 'Tiers self-host (1, 2) se facturan anualmente por adelantado, con un mínimo de 12 meses — no hay versión mensual. Tiers SaaS (3, 4) facturan mensual por defecto; commit anual con prepago da 15% de descuento. Tier 5 (white-label/OEM) también es anual: los tramos de Tier 2 ×1,6.',
    faq_q3: '¿Ofrecen descuento académico o non-profit?',
    faq_a3: 'Sí. Organizaciones non-profit registradas y universidades acreditadas obtienen 50% de descuento sobre el tramo base del tier — en Tier 2, los primeros 25 agentes licenciados; los tramos por encima van a precio de lista. Manda licencia + comprobante a licensing@verbara.io.',
...
const en_US: Messages = {
  ...
  home: {
    ...
    pt_card_self_price: 'from $18k/year',
  ...
  pricing: {
    ...
    tier_2_name: 'Pro Self-Host Business',
    tier_2_price: 'from $18,000 / yr · 25 licensed agents',
    ...
    faq_a2: 'Self-host tiers (1, 2) are billed annually in advance, on a 12-month minimum — there is no monthly version. Managed SaaS tiers (3, 4) bill monthly by default; an annual commit with prepayment gets 15% off. Tier 5 (white-label/OEM) is annual too: Tier 2 bands ×1.6.',
    faq_q3: 'Do you offer a non-profit or academic discount?',
    faq_a3: 'Yes. Registered non-profits and accredited universities get 50% off the base band of the tier — on Tier 2, the first 25 licensed agents; bands above that are list price. Send your license proof + organization paperwork to licensing@verbara.io.',
...
const pt_BR: Messages = {
  ...
  home: {
    ...
    pt_card_self_price: 'a partir de $18k/ano',
  ...
  pricing: {
    ...
    tier_2_name: 'Pro Self-Host Business',
    tier_2_price: 'a partir de $18.000 / ano · 25 agentes licenciados',
    ...
    faq_a2: 'Tiers self-host (1, 2) são faturados anualmente e antecipado, com mínimo de 12 meses — não tem versão mensal. Tiers SaaS (3, 4) faturam mensal por padrão; commit anual com pré-pagamento ganha 15% de desconto. Tier 5 (white-label/OEM) também é anual: as faixas do Tier 2 ×1,6.',
    faq_q3: 'Oferecem desconto acadêmico ou non-profit?',
    faq_a3: 'Sim. Organizações non-profit registradas e universidades credenciadas têm 50% de desconto sobre a faixa base do tier — no Tier 2, os primeiros 25 agentes licenciados; faixas acima vão a preço de lista. Envie comprovante da licença + documentação da organização para licensing@verbara.io.',
